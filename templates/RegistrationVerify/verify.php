 ...
 * @var string $email
 */
$this->assign('title', __('Email Verification'));
?>
    ...
    <div class="column-responsive column-80">
        <div class="users form verification-form">
            <div class="verification-header">
                <h2 class="text-center"><?= __('Email Verification') ?></h2>
                <div class="verification-email">
                    <p><?= __('To complete your registration, please enter the 6-digit verification code sent to:') ?></p>
                ...
                <div class="code-hint">
                    ...
                    <?php if (\Cake\Core\Configure::read('debug')): ?>
                        <?php 
                            ...
                            if ($lastCode && $lastCode['email'] === $email):
                        ?>
            ...
            <div class="verification-actions">
                <?= $this->Form->button(__('Verify & Create Account'), ['class' => 'button primary-button']) ?>
                <?= $this->Form->end() ?>
            </div>
            ...
            <div class="verification-options">
                ...
                <div class="option-section">
                    <h4><?= __("Need to change your information?") ?></h4>
                    <p><?= $this->Html->link(__('Go back to registration form'), ['action' => 'index'], ['class' => 'back-link']) ?></p>
                </div>
            </div>
        </div>
    </div>
