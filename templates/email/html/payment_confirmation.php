...
<div style="font-family: Arial, Helvetica, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
    ...
    <div style="background-color: #f3f4f6; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
        ...
        <p>Your payment for writing services has been successfully processed. Here are your payment details:</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr>
                ...
                <td style="padding: 10px; border-bottom: 1px solid #e5e7eb; font-weight: bold; color: #16a34a;">$<?= number_format($payment->amount, 2) ?></td>
            </tr>
            <tr>
    ...
    <div style="background-color: #ecfdf5; border-left: 4px solid #16a34a; padding: 15px; margin-bottom: 25px;">
        ...
        <p style="margin-bottom: 0; color: #1f2937;">
            We have now started working on your writing service request. You can check the status of your request 
            at any time by logging into your account. We'll keep you updated on our progress.
        </p>
    </div>
    
    <div style="text-align: center; margin-top: 30px;">
        <a href="<?= $this->Url->build(['controller' => 'WritingServiceRequests', 'action' => 'view', $request->writing_service_request_id, 'prefix' => false], ['fullBase' => true]) ?>" style="display: inline-block; background-color: #16a34a; color: white; text-decoration: none; padding: 12px 25px; border-radius: 5px; font-weight: bold;">
            View Request Status
        </a>
    </div>
